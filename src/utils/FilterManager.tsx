...
export const FilterContext = React.createContext<FilterInterface>({ getSymbol: () => '', setSymbol: (e) => {}, getDates: () => ({startDate:moment().format('yyyy-MM-DD'), endDate: moment().format('yyyy-MM-DD')}), setDates: (type) => (e) => {}});
